 ...
 */
class NgxBankAccountBrComponent {
    constructor() {
 ...
 */
/** @type {?} */
const Directive = [NgxBankAccountBrComponent];
class NgxBankAccountBrModule {
}
