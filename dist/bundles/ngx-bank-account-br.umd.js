(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ngx-bank-account-br', ['exports', '@angular/common', '@angular/forms', '@angular/core'], factory) :
    (factory((global['ngx-bank-account-br'] = {}),global.ng.common,global.ng.forms,global.ng.core));
     ...
     */
    var NgxBankAccountComponent = /** @class */ (function () {
        function NgxBankAccountComponent() {
         ...
         * @return {?}
         */
        NgxBankAccountComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () { };
        NgxBankAccountComponent.decorators = [
        ...
        /** @nocollapse */
        NgxBankAccountComponent.ctorParameters = function () { return []; };
        NgxBankAccountComponent.propDecorators = {
            account: [{ type: core.Input, args: ['account',] }],
            form: [{ type: core.ViewChild, args: ['accountForm',] }]
        };
        return NgxBankAccountComponent;
    }());
     ...
     */
    /** @type {?} */
    var Directive = [NgxBankAccountComponent];
    var NgxBankAccountModule = /** @class */ (function () {
        function NgxBankAccountModule() {
        }
        NgxBankAccountModule.decorators = [
    ...
    exports.NgxBankAccountModule = NgxBankAccountModule;
    exports.ɵa = NgxBankAccountComponent;
